...
impl QRWidget {
    ...
    pub fn set_text(&mut self, text: String) {
        ...
        self.text = text;
        let code =
            qrcode::QrCode::with_error_correction_level(self.text.as_bytes(), qrcode::EcLevel::M)
                .unwrap_or_else(|_| {
...
impl Widget for QRWidget {
    ...
    fn paint(&mut self, _ctx: &mut PaintCtx<'_>, _props: &PropertiesRef<'_>, scene: &mut Scene) {
        ...
        scene.fill(Fill::NonZero, Affine::IDENTITY, &white, None, &bg_rect);
        ...
        for (i, module) in self.modules.iter().enumerate() {
            if *module {
                ...
                scene.fill(Fill::NonZero, Affine::IDENTITY, &black, None, &rect);
            }
        }
    }
